...
const deleteProject = async (req, res) => {
    try {
        const request = await Campaign.cancelCampaign(req.params.id);
...
const fundProject = async (req, res) => {
    try {
        ...
        const data = await Campaign.fundProject(id, from, value, hash);
...
module.exports = { addNewProject, getProjectsList, getProjectById, getUsersProjects, deleteProject, fundProject, getProjectTransactions, releaseFunds, collectFunds, getPlatformBalance };